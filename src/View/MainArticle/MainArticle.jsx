    ...
    return (
        <div className={style.container}>
            ...
            <div className={style.articleContainer}>
                ...
                <div className={style.text}>
                    Nadie se realiza en una comunidad que no se realiza, decía el General Perón y agregaba: ¨El problema del pensamiento
                    democrático futuro está en resolvernos  a dar cabida en su paisaje a la comunidad…¨
                </div>
                <div className={style.text}>
