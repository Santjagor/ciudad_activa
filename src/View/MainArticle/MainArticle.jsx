    ...
    return (
        <div className={style.container}>
            <Helmet>
                ...
                <meta name="og:image" property="og:image" content="https://nicolas-carrillo.vercel.app/Logo4.png" />
            </Helmet>
            ...
            <div className={style.articleContainer}>
                ...
                <div className={style.text}>
                    <strong>La renovación debe surgir de acuerdos, no ya un mero consenso respecto a cómo vemos algo, sin demasiado involucramiento, que focalicen en denominadores comunes; es decir, sobre la base de:</strong>
                </div>
                <ul className={style.list}>
                    <li>A - Una reconfiguración de las relaciones laborales en un contexto donde el capital transnacional (global y globalizante) prescinde del empleo y del trabajo convencional, como instrumento central para la generación de utilidades; la marcada estratificación de los ingresos y de los rubros que se establecen como puntales de los mismos, excluye un amplio porcentaje de la población que ingresa al empleo informal, no registrado y precarizado, frente al cada vez más concentrado segmento de ingresos altos, cuya concentración bifurca cualquier promedio representativo;</li>
                    <br />
