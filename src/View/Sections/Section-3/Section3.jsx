        ...
        <div>
            <div className={style.container}>
                <div className={style.articleContainer}>
                    <div className={style.subtitle}>Vivienda e integración urbana</div>
                    ...
                    <ul>
                        <li>A. El cincuenta por ciento (50%) de los gastos que demanden la compra y demás tramitaciones vinculadas a cualquier forma de transferencia   de tierras o planes de vivienda que beneficien a sectores de escasos recursos.</li>
                        <li>B. El otro cincuenta por ciento (50%) para la ejecución de redes de servicios básicos y equipamientos sociales para barrios populares cuyo objetivo sea la integración socio urbana.</li>
                    </ul>
