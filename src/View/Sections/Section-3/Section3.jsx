        ...
        <div>
            <div className={style.container}>
                <div className={style.topImageContainer}>
                    <img src="banner-urbano.webp" alt="" className={style.topImage} />
                </div>
                <div id='Inicio' className={style.title}>Vivienda e integración urbana</div>
                <div className={style.articleContainer}>
                    <div className={style.subtitle_2}>Los datos del último censo reportan que Tandil evidencia el mas bajo nivel de acceso a la vivienda propia en la Provincia de Buenos Aires.</div>
                    ...
                    <img src="02.webp" alt="02" className={style.image} />
