        ...
        <div>
            <div className={style.container}>
                ...
                <div className={style.articleContainer}>
                    <div className={style.text}>En un tiempo presente signado por diagnósticos críticos, sin esperanza ni aparente respuesta a los problemas cotidianos que atraviesa nuestra sociedad, es tiempo de potenciar la inteligencia colectiva, para abordar la complejidad de la democracia inmersa en una crisis, no solo global, sino estructural; donde sus cimientos han sido erosionados en los últimos veinte años, por una triada apocalíptica: crisis política, crisis económica, crisis social.</div>
                    ...
                    <br />
                    <div className={style.text}>El gobierno Radical de Miguel Lunghi pone en evidencia su carácter de gobierno cada vez mas  cerrado.  Todas las decisiones se toman a espaldas a la sociedad, que no participa ni de la formulación ni del control de las políticas públicas.  Además, el desgaste  de 20 años de gestión está acompañado de pérdida de políticas estratégicas, falta de cuadros para la gestión y reina la improvisación.</div>
                    ...
                    <div className={style.text}>Nadie se realiza en una comunidad que no se realiza, decía el General  Perón  y agregaba . ¨El problema del pensamiento democrático futuro esta en resolvernos  a dar cabida en su paisaje a la comunidad….¨</div>
